...
I obtained my PhD from the Machine Learning Department, School of Computer Science, Carnegie Mellon University.  My research  interests include sample-efficient learning (e.g., meta learning, domain adaptation, self-supervised learning, etc.), ML for healthcare, deep learning for natural language processing and computer vision, probabilistic graphical models, large-scale distributed learning.
